...
import { getFormationSessions, getFormationAteliers, getFormationInscriptions, getFormationStats, getAllProgrammeAtelierMappings, getWorkerFormations } from '@/lib/actions/formations'
...
export default async function FormationsPage() {
  ...
  if (!isAdmin) {
    const [myInscriptions, sessions, ateliers, progAtelierMappings] = await Promise.all([
